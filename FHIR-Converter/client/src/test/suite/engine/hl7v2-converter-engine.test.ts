...
// import { ConverterEngineOption } from '../../../core/interface/tmp';
// import { DefaultHl7v2ExePath } from '../../../core/common/constants/constants';
...
// 	const hl7v2Engine = new Hl7v2FhirConverterEngine(ConverterType.hl7v2ToFhir);
...
// 		const Engine = new Hl7v2FhirConverterEngine(ConverterType.hl7v2ToFhir);
...
// 		const type = ConverterType.cdaToFhir;
// 		const Engine = new Hl7v2FhirConverterEngine(ConverterType.hl7v2ToFhir);
// 		Engine.type = type;
// 		assert.strictEqual(ConverterType.cdaToFhir, Engine.type);
// 	});
