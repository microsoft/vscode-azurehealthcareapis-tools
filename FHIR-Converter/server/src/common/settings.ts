...
export class SettingsManager {
	...
	private readonly defaultSettings: FhirConverterSettings = { templateFolder: '', dataFolder: '' };
	...
	constructor (private connection: Connection, capabilities: ClientCapabilities, callback: (doc: TextDocument) => void){
		...
		connection.onDidChangeConfiguration(change => {
			if (this.hasConfigurationCapability) {
				...
				this.globalSettings = <FhirConverterSettings>(change.settings.fhirConverter || this.defaultSettings);
			}
